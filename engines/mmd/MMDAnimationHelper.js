...
import { CCDIKSolver } from 'https://cdn.jsdelivr.net/npm/three@0.150.0/examples/jsm/animation/CCDIKSolver.js';
import { MMDPhysics } from 'https://cdn.jsdelivr.net/npm/three@0.150.0/examples/jsm/animation/MMDPhysics.js';
...
class MMDAnimationHelper {
	...
	constructor(params = {}) {
		...
		this.configuration = {
			mixAnimation: params.mixAnimation !== undefined ? params.mixAnimation : true,
	...
	_setupMeshAnimation(mesh, animation) {
		...
		if (animation !== undefined) {
			...
			//defaultly mixing all animations at once.
			if (this.configuration.mixAnimation) {
